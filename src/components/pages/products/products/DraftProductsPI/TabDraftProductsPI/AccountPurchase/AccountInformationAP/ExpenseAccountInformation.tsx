...
const ExpenseAccountInformation = () => {
  ...
  return (
    <div className="block">
      <Label required>Expense Account</Label>
      <Combobox
        ...
        value={accountPurchase.accounting.expense_account.name}
...
export default ExpenseAccountInformation

...
const ProductVolume = () => {
  ...
  return (
    <section className="flex flex-col gap-2">
      <h2 className="text-sm font-bold">Product Volume</h2>

      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-4">
          <div className="block">
            <Label htmlFor="dimension-product-volume">Dimension (Length x Width x Height)</Label>

            <div className="flex items-center gap-1">
              <Input
                id="dimension-product-volume"
                type="number"
                min="0"
                value={inventory.volume.product_volume?.length}
                onChange={(e) =>
                  setInventory((prev) => ({
                    ...prev,
                    volume: {
              ...
              <Input
                id="width-product-volume"
                type="number"
                min="0"
                value={inventory.volume.product_volume?.width}
                onChange={(e) =>
                  setInventory((prev) => ({
                    ...prev,
                    volume: {
              ...
              <Input
                id="height-product-volume"
                type="number"
                min="0"
                value={inventory.volume.product_volume?.height}
                onChange={(e) =>
                  setInventory((prev) => ({
                    ...prev,
                    volume: {
          ...
          <div className="block w-full">
            <Label htmlFor="volume-product-volume">Volume</Label>
            <Input
              id="volume-product-volume"
              type="number"
              min="0"
              value={inventory.volume.product_volume?.volume}
              onChange={(e) =>
                setInventory((prev) => ({
                  ...prev,
                  volume: {
        ...
        <div className="block w-full">
          ...
          <Combobox
            ...
            value={inventory.volume.product_volume?.uom?.format}
            onValueChange={(value) => {
